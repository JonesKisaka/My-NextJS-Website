...
interface WorkSectionProps {
  projects: Project[]
  sectionType: 'hardware' | 'software'
}

export default function WorkSection({ projects, sectionType }: WorkSectionProps) {
  return (
        ...
        <div className="project-info">
          <div className="project-header">
            ...
            <div className="project-timeline">
              ...
              <span className="timeline-value">{project.timeline}</span>
            </div>
          </div>
          ...
          <div className="project-links">
            {project.linkType !== 'none' && project.githubLink && (
              <a 
